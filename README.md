...
Dokumentasi proyek tersedia di [`docs/README.md`](docs/README.md). Dokumen utama meliputi PRD, FRD global dan per fitur, IA, `db.md`, desain UI, DDL PostgreSQL, ERD, dan sample data. Implementasi HTML/CSS tersedia di [`src/prototype/`](src/prototype/README.md).
