...
**Status:** tahap perancangan. PRD, FRD, arsitektur, model data, dan dataset. Target pengerjaan MVP setelah rancangan disetujui adalah sekitar satu bulan oleh satu pengembang.
...
| [FRD per fitur]() | Rincian FR-01 sampai FR-06: cari AWB, status/linimasa, peta, suhu, Refresh, dan sumber suhu Node-RED. | 3 |
...
| [Dataset]() | CSV, penjelasan kolom, skenario, dan urutan impor. | 6 |
...
Memuat 70 AWB dengan variasi tahap `PICKED_UP`, `AT_HUB`, `IN_TRANSIT`, `OUT_FOR_DELIVERY`, dan `DELIVERED`; Dataset dipakai selama perancangan dan **belum dibekukan sebagai versi akhir pengembangan**.
