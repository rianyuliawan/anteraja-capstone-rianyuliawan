...
| FR-02 | P0 | Ringkasan, linimasa, dan dokumentasi | Titik pickup/tujuan, status terakhir, tahap yang tercatat, serta foto pickup/delivery yang lolos pemeriksaan privasi. | [Spesifikasi](frd/fr-02-status.md) |
